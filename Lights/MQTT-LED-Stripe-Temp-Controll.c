...
#define PINBLUE 0
#define PINDHT 1
#define DHTTYPE DHT22 //alternative DHT11
#define CRITICALTEMP 40 // in °C
...
//READ THE SENSOR
int readDHT() {
    // Reading temperature takes about 250 milliseconds! They might be a few seconds old (up to 2).
